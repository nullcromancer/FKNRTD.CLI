...
public static class Glossary
{
    ...
    [
        ...
        new("stagestate.pending", "Pending  ○", StageStates,
            "Not reached yet.",
            "The pipeline has not arrived at this stage."),
        new("stagestate.running", "Running  ▶", StageStates,
            "Executing now.",
            "This stage is the one currently live."),
        new("stagestate.passed", "Passed  ✓", StageStates,
            "Completed successfully.",
            "The stage finished and met its condition."),
        new("stagestate.failed", "Failed  ✖", StageStates,
            "Completed unsuccessfully. The task stopped here.",
            "The stage ran and did not meet its condition. Its log holds the output."),
        new("stagestate.skipped", "Skipped  ◇", StageStates,
            "Deliberately not applicable — not a failure.",
            "The stage did not apply to this workspace, most often the worktree stage in a " +
            "standalone workspace where there is nothing to isolate."),
