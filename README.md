...
(`tests/FKNRTD.SelfTest/Program.cs`), currently 43 checks, all passing on this checkout.
...
when every check passes. Verified on this checkout: `43/43 self-tests passed`.
