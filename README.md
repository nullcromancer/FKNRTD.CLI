...
(`tests/FKNRTD.SelfTest/Program.cs`), currently 44 checks, all passing on this checkout.
...
when every check passes. Verified on this checkout: `44/44 self-tests passed`.
